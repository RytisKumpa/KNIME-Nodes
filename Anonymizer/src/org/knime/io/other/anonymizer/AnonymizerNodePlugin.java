 ...
 * @author Rytis Kumpa
 */
public class AnonymizerNodePlugin extends Plugin {
    // The shared instance.
    private static AnonymizerNodePlugin plugin;

    /**
     * The constructor.
     */
    public AnonymizerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static AnonymizerNodePlugin getDefault() {
        return plugin;
    }
