 ...
 * @author Rytis Kumpa
 */
public class DaviesBouldinIndexNodePlugin extends Plugin {
    // The shared instance.
    private static DaviesBouldinIndexNodePlugin plugin;

    /**
     * The constructor.
     */
    public DaviesBouldinIndexNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DaviesBouldinIndexNodePlugin getDefault() {
        return plugin;
    }
